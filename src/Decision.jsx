...
export default class Decision extends React.Component{
    ...
    handleAlert1(){
        return <Alert show={this.state.show} style={{position:'absolute', top:'50%', left:'50%',transform:'translate(-50%,-50%)', fontSize:18}}
    ...
    handleAlert2(){
        return <Alert show={this.state.show2} style={{position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', fontSize:18}}
    ...
    handleAlert3 (){
        return <Alert show={this.state.show3} style={{position:'absolute', top:'50%', left:'50%',transform:'translate(-50%,-50%)', fontSize:18}}
